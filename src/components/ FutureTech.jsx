		...
		<section className='py-10 sm:py-11 md:py-12 lg:py-14 xl:py-24 2xl:py-[120px] bg-[#1a1a1a] text-white'>
			<div className='custom-container'>
				<div className='block sm:flex items-center mb-[100px]'>
					<div className='flex items-center mr-5 sm:mr-6 md:mr-7 lg:mr-8 xl:mr-[60px] 2xl:mr-20'>
						<img
					...
					<div>
						<button className='hidden sm:block bg-[#333] py-[6px] px-[10px] mb-4 font-medium text-xl leading-normal tracking-[-3px] '>
							Learn, Connect, and Innovate
						</button>
						...
						<p className='text-[#7E7E81] text-sm sm:text-base xl:text-lg'>
				...
				<ul className='bg-[#141414] border-[1px] border-[#262626] border-solid flex flex-col md:flex-row justify-between p-[10px] sm:p-3 lg:p-4 xl:p-5'>
					<li className='custom-li bg-[#262626]  border-[1px] border-[#1a1a1a] border-solid w-full max-w-[98%] xl:max-w-[505px] p-6 sm:p-7 md:p-8  xl:p-9 2xl:p-10'>
						<div className='custom-flex2 mb-[10px] sm:mb-3 md:mb-4 xl:mb-5'>
